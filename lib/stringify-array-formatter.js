    ...
    type(type) {
        ...
        switch (type.type) {
            ...
            case Types.TypeApplication:
                // --------------------------------------------------------------------
                // Replace the default for TypeApplication with modified applications
                // method accepting dataType and the applications object.
                // --------------------------------------------------------------------
...
module.exports = (type, options) => new StringifierArrayFormatter(options).stringify(type);
